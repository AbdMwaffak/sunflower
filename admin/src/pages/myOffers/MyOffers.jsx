                        ...
                        <Form noValidate validated={validated} onSubmit={handleSubmit} className='addOffer'>
                            ...
                            <Row>
                                <Form.Group as={Col} className="mb-3 " controlId="validationCustom02">
                                    <Form.Label>Add old price  </Form.Label>
                                    <Form.Control
                                        type="number"
                                        min={1}
                            ...
                            <hr />
                            <button type="submit" className='formButton'>add new offer</button>

                        </Form>

                        <div className='editOfferDisplay'>
                            <div className='imgSlider'>
                                <img src={imageSquer} alt="" />


                            </div>
                            <div className='editProductInfo'>
                                <div className='divInfo'> Name : {name}   </div>
                                <hr />
                                <div className='divInfo'> discount : {discount}%   </div>
                                <hr />
                ...
                <div className='currentOffers'>
                    {allOffers?.length == 0 &&
                        <div className='noProducts' >
                            <b> you don't have any offers yet
                            ...
                            <br />
                            <b>
                                start adding offers from the above
