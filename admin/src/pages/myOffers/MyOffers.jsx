                    ...
                    <div className='newOffer'>
                        ...
                        <div className='disblayOffer'>
                            ...
                            <div className='editOfferInfo'>
                                <div className='divInfo'> {t('offers.name')} : {lng == "ar" ? nameAr : name}   </div>
                                <hr className='tapp' />
                                <div className='divInfo'> {t('offers.discount')} : {discount}%   </div>
                                <hr className='tapp' />
                                <div className='divPrice'>
                                    <div className='oldPrice'>  {oldePrice}.{t("public.sar")} </div>
