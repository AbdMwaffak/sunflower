        ...
        <>
            ...
            {openModel1 &&
                <ErrorMessage
                    ...
                    messageTitle="ERROR"
                    message="Opps! , you can't change state because no products in this category "
                />
            }
                ...
                <div className='editeCategoryContener'>
                    <div className='newCategory'>
                        <div className='addCategory'>
                            <div className=''>
                                This category is {categories?.isActive ? "active" : "n0t active"}
                            </div>
                            <div className='onOff'>
                                <button type='submit' className='formButton' onClick={handleState}> {categories?.isActive ? "Disable" : "Enable"}  </button>
                        ...
                        <div className='displayNewCategory'>
                            ...
                            <div className='newTitleCategory'>
                                {startName}
                                <div className='nameTop' >    {name}  </div>
                            </div>
                        </div>
                    </div>
                </div >
