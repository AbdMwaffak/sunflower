        ...
        <>
            ...
            {openModel1 &&
                <ErrorMessage
                    ...
                    messageTitle="ERROR"
                    message="Opps! , you can't change state because no products in this offer "
                />
            }
            <div className='editeOffers'>
                ...
                <div className='editeOfferContener'>
                    <div className='newOffer'>
                        <div className='editeOffer'>
                            <div className='activeTitel'>
                                This offer is {offer?.isActive ? "active" : "not active"}
                            </div>
                            <div className='onOff'>
                                <button type='submit' className='formButton' onClick={handleState}> {offer?.isActive ? "Disable" : "Enable"}  </button>
                                <button type='submit' className='formButton' onClick={handleDelete}> Delete  </button>
                            </div>
                            <hr />
                            ...
                            <Form noValidate validated={validated5} onSubmit={handleSubmit5} className='addCategory1'>
                                <Row>
                                    ...
                                    <Form.Group as={Col} className="mb-3" controlId="validationCustom01">
                                        <Form.Label>Add olde price</Form.Label>
                                    ...
                                    <Form.Group as={Col} className="mb-3" controlId="validationCustom01">
                                        ...
                                        <Form.Label>Add new price</Form.Label>
                                        <div className='rowEdit'>
                                            <div className='addCategory1'>
                                                <Form.Control
                                                    type="number"
                        ...
                        <div className='editOfferDisplay'>
                            <div className='imgSlider'>
                                <img src={imageSquer == "" ? offer?.mainImage : imageSquer} alt="" />


                            </div>
                            <div className='editProductInfo'>
                                <div className='divInfo'> Name : {name == " " ? offer?.name : name}   </div>
                                <hr />
                                <div className='divInfo'> discount : {discount == " " ? offer?.discount : discount}%   </div>
                                <hr />
                ...
                <div className='produtsByOffer'>
                    {offer?.products?.length == 0 &&
                        <div className='noProducts' >
                            <b> you don't have any product in this offfer yet
                            ...
                            <br />
                            <b>
                                start adding products from the above
