...
const SidBar = ({ sid }) => {
    ...
    return (
        <div className='sidBar' style={{ width: sid ? "250px" : "60px" }}>

            <Link to={'/MyCategory'} className={sid ? "sidActive" : "sidUnActive"}  >
                <div className="linkName" style={{ width: sid ? "100%" : "0" }}> My Category   </div>
                <div className='linkIcon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24" ><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 4h6v6H4zm10 0h6v6h-6zM4 14h6v6H4zm10 3a3 3 0 1 0 6 0a3 3 0 1 0-6 0"></path></svg>
                </div>
            </Link>
            <Link to={'/MyNaturalFlower'} className={sid ? "sidActive" : "sidUnActive"}  >
                <div className='linkName' style={{ width: sid ? "100%" : "0" }}> My NaturalFlower   </div>
                <div className='linkIcon'>
            ...
            <Link to={'/MyOffers'} className={sid ? "sidActive" : "sidUnActive"}  >
                <div className='linkName' style={{ width: sid ? "100%" : "0" }}> My Offers  </div>
                <div className='linkIcon'>
            ...
            <Link to={'/About'} className={sid ? "sidActive" : "sidUnActive"}  >
                <div className='linkName' style={{ width: sid ? "100%" : "0" }}> About Store   </div>
                <div className='linkIcon'>
            ...
            <Link to={'/Setting'} className={sid ? "sidActive" : "sidUnActive"}  >
                <div className='linkName' style={{ width: sid ? "100%" : "0" }}> About Setting   </div>
                <div className='linkIcon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 16 16" ><path fill="currentColor" fillRule="evenodd" d="M10.5 1a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V4H1.5a.5.5 0 0 1 0-1H10V1.5a.5.5 0 0 1 .5-.5M12 3.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5m-6.5 2A.5.5 0 0 1 6 6v1.5h8.5a.5.5 0 0 1 0 1H6V10a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5M1 8a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2A.5.5 0 0 1 1 8m9.5 2a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V13H1.5a.5.5 0 0 1 0-1H10v-1.5a.5.5 0 0 1 .5-.5m1.5 2.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5"></path></svg >
                </div>
            </Link >
        </div >
    );
