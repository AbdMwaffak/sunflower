...
function RegisterModel(props) {
    ...
    return (
        <>
            ...
            <button className='formButton' style={{ margin: "0 5%" }} onClick={handleShow}> Go To Register   </button>
            ...
            >
                ...
                <Modal.Body >
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit} className='boxRegister' >
                        ...
                        <Modal.Footer >
                            <button type="submit" className='formButton' style={{ margin: "0 5%" }} > Login   </button>
