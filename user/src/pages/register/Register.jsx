...
const Register = () => {
  ...
  return (
    <div className='bage'>
      <div className='title'>{t('public.register')}</div>
        ...
        >
          <div className='formBody'>
            <Form.Group className='mb-3' controlId='form1'>
              <Form.Label>{t('public.image')}</Form.Label>
              <Form.Control type='file' onChange={handelimag} />
            </Form.Group>
            <Row>
            ...
            <Form.Group className='mb-3' controlId='form6'>
              ...
              <div className='passsWorlContent '>
                ...
                <button
                  ...
                  style={{ right: lng == 'ar' ? 'calc(100% - 50px)' : '20px' }}
            ...
            <Form.Group className='mb-3' controlId='form7'>
              <Form.Label>{t('public.confirmPassword')}</Form.Label>
              <div className='passsWorlContent '>
                <Form.Control
                  type={hiddenB ? 'password' : 'text'}
                  placeholder='**********'
