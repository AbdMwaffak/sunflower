          ...
          <div className='noProducts'>
            ...
            <b>
              ...
              >
                <path
                  fill='#d9cdab'
                  d='m30.415 9.586l-9-9a2.001 2.001 0 0 0-2.829 2.829l-3.859 3.859l9 9l3.859-3.859a2 2 0 0 0 2.829-2.829'
                ></path>
                <path
                  fill='#ece4d0'
                  d='M20 0H5a4 4 0 0 0-4 4v28a4 4 0 0 0 4 4h22a4 4 0 0 0 4-4V11h-9c-1 0-2-1-2-2z'
                ></path>
                <path
                  fill='#202126'
                ...
                <path
                  fill='#d9cdab'
                  d='M31 19s-5.906-.002-5.935 0c-.291 0-.91.174-1.255.606l-2.328 2.929c-.644.809-.644 2.119 0 2.93l2.328 2.929c.345.432.964.606 1.255.606c.019.002 3.547 0 5.935 0z'
                ></path>
                <path
                  fill='#F1C92F'
                  d='M33 19s-8.056-.002-8.084 0c-.291 0-.91.139-1.255.485l-2.328 2.342a1.665 1.665 0 0 0 0 2.344l2.328 2.342c.345.346.964.487 1.255.487c.028.002 8.084 0 8.084 0c1.104 0 2-.897 2-2.001V21a2 2 0 0 0-2-2'
                ></path>
              </svg>
            </b>
          </div>
        ...
        {articels
          ...
          ?.map((articel) => (
            <Post
              ...
              image={articel?.image}
              description={
                lng == 'ar' ? articel?.descriptionAr : articel?.description
              }
