  ...
  return (
    <>
      ...
      <div className='home'>
        ...
        <div className='ourCategorysTitle'>Our Categorys</div>
        <div className='ourCategorys'>
          ...
          <CategorysCard image={NaturalFlowers} name='NaturalFlowers' />
          <CategorysCard image={Perfumes} name='Perfumes' />
          {allCategories
            ?.filter((cate) => {
        ...
        <div className='ourOffersTitle'>Our Offers</div>
        <div className='ourOffers'>
          {allOffers?.length == 0 && (
            <div className='new1'>
              ...
              >
                ...
                ></path>
                <path fill='#fcab40' d='M3 15h30v2H3z'></path>
                <path
                  fill='#da2f47'
          ...
          {allOffers?.length != 0 && (
            <>
              ...
              <SliderX vv={allOffers} numCounter={props?.numCounter} />{' '}
            </>
          )}
        </div>
        <div className='deliveryTitle'>Delivery Serves</div>
        <div className='delivery'>
          <div className='deliveryText'>
            <div>
              Delivery of flowers and cakes to
              <br />
              <span className='vv'> Dammam </span> and{' '}
              <span className='vv'> Khobar</span>
            </div>
            <div>
              Delivery of the rest of the products to <br />
              <span className='vv'> the Eastern Province </span> and{' '}
              <span className='vv'>Riyadh </span>
            </div>
          </div>
