          ...
          <div className="formBody">
            {status == "failed" && (
              <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Form.Group
                  ...
                  style={{ width: "100%" }}
                >
                  <Form.Label>{t("cart.RecipientPhone")}</Form.Label>
                  <div className="qq">
                    <PhoneInput
                      country={"sa"}
                      required
                ...
                <Form.Group className="mb-3" controlId="form3">
                  <Form.Label>{t("cart.city")}</Form.Label>
                  <Form.Select
                    className="input4"
                ...
                <Form.Group className="mb-3" controlId="form2">
                  <Form.Label>{t("cart.adressDetails")}</Form.Label>
                  <Form.Control
                    type="text"
                    placeholder="....."
                    required
                ...
                <Form.Group className="mb-3" controlId="form1">
                  <Form.Label>{t("cart.notes")}</Form.Label>
                  <Form.Control
                    type="text"
                    placeholder="....."
            ...
            {status == "loading" && (
              <div className="sendLoding">
                ...
                <h4 style={{ color: "#151520" }}>{t("cart.sendingOrder")}</h4>
              </div>
            )}
            {status == "success" && (
              <div className="sendLoding">
