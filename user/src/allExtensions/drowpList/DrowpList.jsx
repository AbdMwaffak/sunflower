...
const DrowpList = (props) => {
  ...
  return (
    <div
      className={props.DrowpListButton ? 'drowpListT' : 'drowpListF'}
      onClick={() => seteng(!eng)}
      ref={props?.menuRef}
    ...
    >
      ...
      <Link
        ...
        className='linkDL'
        onClick={() => props.DrowpListButtonHandler()}
      >
        <div className='listItem'>{t('drowpList.myAccount')}</div>
      </Link>
      ...
      <Link
        ...
        onClick={() => props.DrowpListButtonHandler()}
      >
        <div className='listItem'>{t('drowpList.myOrder')}</div>
      </Link>
      <Link
        to={'/MyFavorites'}
        className='linkDL'
        onClick={() => props.DrowpListButtonHandler()}
      >
        <div className='listItem'>{t('drowpList.myFavorites')}</div>
      </Link>
    </div>
  );
};
