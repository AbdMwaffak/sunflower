    ...
    <div className='extraChocolate'>
      <div className='vvcheck'>
        <label className='container'>
          <input
            ...
            onChange={() => {
              state
                ? handelIncreaseChocolate(chocolateNum + 1)
        ...
        >
          ...
          >
            <path
              id='Path_2299'
              data-name='Path 2299'
              d='M4,0H28a4,4,0,0,1,0,8H4A4,4,0,0,1,4,0Z'
              fill='#f1c92f'
            />
          </svg>
        </button>
        ...
        >
          ...
          >
            ...
            <path
              ...
              data-name='Path 2298'
              d='M4,0H28a4,4,0,0,1,0,8H4A4,4,0,0,1,4,0Z'
              transform='translate(12 32) rotate(-90)'
              fill='#f1c92f'
            />
          </svg>
        </button>
      ...
      <>
        <div className='chocolateImage '>
          <img
            className='chocolateImg'
            src={`${Api}/users/${props?.image}`}
            alt='no image'
          />
        </div>
        <svg
          className='tringelTail'
          xmlns='http://www.w3.org/2000/svg'
          width={50}
          height={50}
          viewBox='0 0 24 24'
