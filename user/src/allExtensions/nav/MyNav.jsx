      ...
      {!smSeartch && (
        <div className='sercheIn2'>
          <button
            ...
            style={{ transform: lng == 'ar' ? 'rotate(180deg)' : ' ' }}
          >
            <svg
          ...
          <form className='sercheInputform'>
            ...
            ></input>
            <button type='supmit' className='start' onClick={hanleSearch}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width={25}
                height={25}
      ...
      {smSeartch && (
        <>
          <div className='leftNav'>
            ...
            <div
              className='menue'
              style={{ display: sidBarButton ? 'flex' : 'none' }}
              onClick={() => {
            ...
            <div
              className='menue'
              style={{ display: sidBarButton ? 'none' : 'flex' }}
              onClick={() => {
                sidBarButtonHandlerM();
              }}
            >
            ...
            <Link to={'/'} className=''>
              <div className='logo'>
                <img className='flowerLogo' src={Logo} />
              </div>
            </Link>
            <DarkMode />
            <div className='sercheIn'>
              <form className='sercheInputform'>
                <input
                  ...
                  placeholder={t('search.search')}
                ></input>
                <button className='start' onClick={hanleSearch}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width={25}
                    height={25}
          ...
          <div className='rightNav'>
              ...
              <button className='b1'>
                ...
                >
                  <g
                    ...
                    color='currentColor'
                  >
                    <path d='M8 16h7.263c4.488 0 5.17-2.82 5.998-6.93c.239-1.187.358-1.78.071-2.175s-.837-.395-1.938-.395H6'></path>
                    <path d='M8 16L5.379 3.515A2 2 0 0 0 3.439 2H2.5m6.38 14h-.411C7.105 16 6 17.151 6 18.571a.42.42 0 0 0 .411.429H17.5'></path>
            ...
            <button
              className='b3'
              onClick={() => setDrowpListButton(!DrowpListButton)}
              ref={menuRef}
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
