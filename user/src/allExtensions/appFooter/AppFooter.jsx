                ...
                <div className='appFooterContent2' >
                    ...
                    <div className='allContact'>
                        ...
                        {(allSettings?.email !== "" || null) &&
                            <a href={`mailto:${allSettings?.email}`} target="_blank" rel="noopener noreferrer" className='contSocial'>
                                <div className='contIcon '>
                                    <div className='contCer'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={"80%"} height={"80%"} viewBox="0 0 24 24" ><path fill="currentColor" d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2zm3.519 0L12 11.671L18.481 6zM20 7.329l-7.341 6.424a1 1 0 0 1-1.318 0L4 7.329V18h16z"></path></svg>                        </div>
                                </div>
                                <div className='cont'>   {allSettings?.email}   </div>
                            </a>}
                        {(allSettings?.instagram !== "" || null) &&
                            <a href={`www.instagram.com/${allSettings?.instagram}`} target="_blank" rel="noopener noreferrer" className='contSocial'>
                                <div className='contIcon '>
                                    <div className='contCer'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={"80%"} height={"80%"} viewBox="0 0 512 512" ><path fill="currentColor" d="M349.33 69.33a93.62 93.62 0 0 1 93.34 93.34v186.66a93.62 93.62 0 0 1-93.34 93.34H162.67a93.62 93.62 0 0 1-93.34-93.34V162.67a93.62 93.62 0 0 1 93.34-93.34zm0-37.33H162.67C90.8 32 32 90.8 32 162.67v186.66C32 421.2 90.8 480 162.67 480h186.66C421.2 480 480 421.2 480 349.33V162.67C480 90.8 421.2 32 349.33 32"></path><path fill="currentColor" d="M377.33 162.67a28 28 0 1 1 28-28a27.94 27.94 0 0 1-28 28M256 181.33A74.67 74.67 0 1 1 181.33 256A74.75 74.75 0 0 1 256 181.33m0-37.33a112 112 0 1 0 112 112a112 112 0 0 0-112-112"></path></svg>
                                    </div>
                                </div>
                        ...
                        {(allSettings?.phone !== "" || null) &&
                            <a href={`tel:${allSettings?.phone}`} target="_blank" rel="noopener noreferrer" className='contSocial'>
                                <div className='contIcon '>
                                    <div className='contCer'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={'80%'} height={"80%"} viewBox="0 0 24 24" ><path fill="currentColor" d="M15.5 1h-8A2.5 2.5 0 0 0 5 3.5v17A2.5 2.5 0 0 0 7.5 23h8a2.5 2.5 0 0 0 2.5-2.5v-17A2.5 2.5 0 0 0 15.5 1m-4 21c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5s1.5.67 1.5 1.5s-.67 1.5-1.5 1.5m4.5-4H7V4h9z"></path></svg>
                                    </div>
                                </div>
