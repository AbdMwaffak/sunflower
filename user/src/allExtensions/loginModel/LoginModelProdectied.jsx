                ...
                <Modal.Body >
                    <Form noValidate validated={validated} onSubmit={handleSubmit} className='boxLogin' >
                        <div className='formBody'>
                            <h3 style={{ width: "100%", textAlign: "center", color: "red" }}> Sorry !!  </h3>
                            <h5 style={{ width: "100%", textAlign: "center" }}>  please log in first </h5>
                            ...
                            <Form.Group className="mb-3" controlId="form2">
                                ...
                                {password.length < 8 &&
                                    <div className='error' > Password is short ! , at least 8 characters</div>
                                }
                            </Form.Group>
                        </div>
                        <Modal.Footer >
                            <button type="submit" className='formButton1' style={{ margin: "0 5%" }} > Login   </button>
                        </Modal.Footer>
                    </Form>
                    <div className='or'>
                        or
                    </div>
                    <button className='formButton2' style={{ margin: "0 7%" }} onClick={goToRegister} > Register   </button>
                </Modal.Body>
            </Modal>
        </>
    );
