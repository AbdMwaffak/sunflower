        ...
        <>
            ...
            >
                ...
                <Modal.Body  >
                    ...
                    <div style={{ display: window != 1 || data1 == "Verifying..." || data2 == "Verifying..." ? 'none' : "flex" }} className='boxLogin'>
                    ...
                    <div style={{ display: window != 0 || data1 == "Verifying..." || data2 == "Verifying..." ? 'none' : "flex" }} className='boxLogin'>
                        {error2 && <p className='err' style={{ color: 'red' }}>{error2.message}</p>}
                    ...
                    <div style={{ display: data1 != "Verifying..." && data2 != "Verifying..." ? 'none' : "flex" }} className='boxLogin'>
                        <OTPVerificationForm
                            phone={phone}
                        />
